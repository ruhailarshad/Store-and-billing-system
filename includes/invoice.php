...
if ($_GET["order_date"] && $_GET["invoice_no"]) {
	...
	$pdf->Cell(190,10,"Empress Store And Billing System",1,1,"C");
	$pdf->Cell(189,10,"North Karachi",0,1,"C");
	...
	$pdf->Cell(100,10,": ".$_SESSION["fname"],0,1);
	$pdf->Output("../pdfinvoice/PDF_INVOICE_".$_GET["invoice_no"].".pdf","F");
